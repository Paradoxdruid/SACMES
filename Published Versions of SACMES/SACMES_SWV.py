...
class MainWindow(tk.Tk):
    ...
    def _create_toolbar(self):
        ...
        editmenu.add_command(
            label="Adjust Current Extraction",
    ...
    def extraction_adjustment_frame(self):
        ...
        self.space_delimiter = tk.Radiobutton(
            win, text="Space", variable=self.delimiter_value, value=1
        )
        self.space_delimiter.grid(row=4, column=0, pady=5)

        self.tab_delimiter = tk.Radiobutton(
            win, text="Tab", variable=self.delimiter_value, value=2
        )
...
class InputFrame(
    ...
    def __init__(self, parent, controller):
        ...
        EmptyLabel = tk.Label(self, text="", font=LARGE_FONT).grid(
            row=4, rowspan=2, column=0, columnspan=10
        )
        ...
        self.ElectrodeListboxFrame.grid(
            row=10, column=0, columnspan=2, padx=10, pady=10, ipady=5, sticky="nsew"
        )
        ...
        self.ListboxFrame.grid(
            row=10, column=2, columnspan=2, padx=10, pady=10, sticky="nsew"
        )
...
class RealTimeManipulationFrame(tk.Frame):
    ...
    def AdjustParameters(self):
        ...
        if self.Low:
            ...
            )  # xstart/xend adjust the points at the start and end of the voltammogram/smoothed currents, respectively
...
class InitializeFigureCanvas:
    ...
    def InitializeSubplots(self, ax, freq, electrode, subplot_count):
        ...
        if e_var == "single":
            self.list_val = (
                electrode * 3
            ) + column_index  # default 'column index' is -2
        ...
        try:
            ...
            root.after(
                1000, self.InitializeSubplots, ax, freq, electrode, subplot_count
            )
...
class ElectrochemicalAnimation:
    def __init__(
        ...
        self.list_val = (
            self.electrode * 3
        ) + column_index  # Electrode column index value
